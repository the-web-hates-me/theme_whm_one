 ...
 * @uses add_theme_support() To add support for post thumbnails, automatic feed
 *       links,
...
function twentytwelve_setup() {
	/*
	 * Makes Twenty Twelve available for translation. Translations can be added
	 * to the /languages/ directory. If you're building a theme based on Twenty
	 * Twelve, use a find and replace to change 'twentytwelve' to the name of
	 * your theme in all the template files.
	 */
	...
	/*
	 * This theme supports custom background color and image, and here we also
...
function twentytwelve_scripts_styles() {
	...
	/*
	 * Loads our special font CSS file. The use of Open Sans by default is
	 * localized. For languages that use characters not supported by the font,
	 * the font can be disabled. To disable in a child theme, use
	 * wp_dequeue_style() function mytheme_dequeue_fonts() { wp_dequeue_style(
	 * 'twentytwelve-fonts' ); } add_action( 'wp_enqueue_scripts',
	 * 'mytheme_dequeue_fonts', 11 );
	 */
	 ...
	 */
	wp_enqueue_style ( 'twentytwelve-ie', get_template_directory_uri () . '/css/ie.css', array (
			'twentytwelve-style'
	), '20121010' );
...
if (! function_exists ( 'twentytwelve_comment' )) :
	 ...
	 * template
	 * simply create your own twentytwelve_comment(), and that function will be
	 * used instead.
	 *
	...
	<article id="comment-<?php comment_ID(); ?>" class="comment">
		<header class="comment-meta comment-author vcard">
				...
				printf ( '<cite class="fn">%1$s %2$s</cite>', get_comment_author_link (),
						// If current post author is also comment author, make
						// it known visually.
...
if (! function_exists ( 'twentytwelve_entry_meta' )) :
	...
	function twentytwelve_entry_meta() {
		...
		// Translators: 1 is category, 2 is tag, 3 is the date and 4 is the
		// author's name.
		if ($tag_list) {
 ...
 * 1.
 * Using a full-width layout, when no active widgets in the sidebar
...
function twentytwelve_body_class($classes) {
	...
	elseif (in_array ( $background_color, array (
			'fff',
			'ffffff'
	) ))
...
function twentytwelve_customize_preview_js() {
	wp_enqueue_script ( 'twentytwelve-customizer', get_template_directory_uri () . '/js/theme-customizer.js', array (
			'customize-preview'
	), '20120827', true );
}
